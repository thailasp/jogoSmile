    ...
    function jogarNovamente() {
      ...
      //armazenamos a imagem do cachorro na variável imagem2 (getElementById)
      let imagem2 = document.getElementById("imagem2");
      //se a imagem nao for vazia (se ela existir)
      if (imagem2 != "") {
        //removemos a imagem do cachorro
        imagem2.remove();
      }
    }
    ...
    function verifica(obj) {
      ...
      if (jogar) {
        ...
        if (obj.id == sorteado) {
          ...
          img.id = "imagem2";
          //altera o atributo src (source) da imagem criada
          img.src = "https://pm1.aminoapps.com/6957/158e4cc35337e96a6fa7e960aa98595b6137f913r1-480-470v2_hq.jpg";
          //adiciona a imagem criada na div (obj) escolhida pelo jogador (appendChild)
          obj.appendChild(img);
